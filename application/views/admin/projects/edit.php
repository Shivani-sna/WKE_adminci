				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4></i> <span class="text-semibold">Edit Project</span></h4>
						</div>
					</div>
										...
										<div class="row">
											<div class="col-md-12">
												<div class="form-group">
													...
													<input type="text" class="form-control" placeholder="Project Name" id="name" name="name" value="<?php echo $project['name']; ?>">
												</div>
												<div class="form-group">
													<small class="req text-danger">*</small>
													<label>Details:</label>
													<input type="text" class="form-control" placeholder="Details" id="details" name="details" value="<?php echo $project['details']; ?>">
												</div>
